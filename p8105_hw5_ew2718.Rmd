...
for (i in 1:5000) {
  output[[i]] = sim_function(mu = 0)
}

sim_results_mu0 = bind_rows(output)
...
for (i in 1:5000) {
  output[[i]] = sim_function(mu = 4)
}

sim_results_mu4 = bind_rows(output)

## mu = 5
output = vector("list", length = 5000)

for (i in 1:5000) {
  output[[i]] = sim_function(mu = 5)
}

sim_results_mu5 = bind_rows(output)

## mu = 6
output = vector("list", length = 5000)

for (i in 1:5000) {
  output[[i]] = sim_function(mu = 6)
}

sim_results_mu6 = bind_rows(output)
```
